...
INSERT INTO `book` VALUES (1,'125031318X','9781250313188','Tamsyn Muir','resetTitle'),(2,'1781084491','9781781084496','Yoon Ha Lee','Ninefox Gambit'),(3,'1781085374','9781781085370','Yoon Ha Lee','Raven Stratagem');
...
CREATE TABLE `user_book` (
  ...
  KEY `user_book_user_id_fk` (`user_id`),
  CONSTRAINT `user_book_book_id_fk` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_book_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `user_role` VALUES (1,'me','administrator',2),(2,'notAdmin','user',1);
...
-- Dump completed on 2020-03-16 15:40:23
