...
insert into user_book_data (user_id, book_id) values (2, 1);
insert into user_book_data (user_id, book_id) values (1, 2);
insert into user_book_data (user_id, book_id) values (1, 3);
